class FractionalNumber{
    ...
    /**
     * constructor FractionNumber
     *
     * Создает экземпляр объекта/класса FractionNumber, который описывает дробь.
     *
     * @param myNumerator - числитель дроби.
     * @param myDenominator - знаменатель дроби.
     * @constructor объекта FractionNumber
     */
    constructor(myNumerator, myDenominator){
